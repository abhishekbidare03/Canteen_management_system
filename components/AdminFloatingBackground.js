// This component is specifically for the Admin dashboard and uses app/FloatingIcons.module.css
import iconStyles from '../app/FloatingIcons.module.css'; // Use the admin-specific CSS

const AdminFloatingBackground = () => {
  return (
    <div className={iconStyles.iconContainer}>
      {/* Icons copied from FloatingBackground.js - Ensure consistency if needed */}
